...
contract ERC721Proxy is ExtendableTokenProxy, ERC721TokenInterface {
    constructor(
        string memory name_,
        ...
        )
    {
        ...
        _protectedFunctions[0] = IERC721Proxy.totalSupply.selector;
        _protectedFunctions[1] = IERC721Proxy.mintingAllowed.selector;
        _protectedFunctions[2] = IERC721Proxy.burningAllowed.selector;
        _protectedFunctions[3] = IERC721Proxy.burn.selector;
        _protectedFunctions[4] = IERC721Proxy.tokenOfOwnerByIndex.selector;
        _protectedFunctions[5] = IERC721Proxy.tokenByIndex.selector;
        _protectedFunctions[6] = IERC721Proxy.mint.selector;
        _protectedFunctions[7] = IERC721Proxy.mintAndSetTokenURI.selector;
        _protectedFunctions[8] = IERC721Proxy.setTokenURI.selector;
        _protectedFunctions[9] = IERC721Proxy.setContractURI.selector;
        _protectedFunctions[10] = IERC721Proxy.contractURI.selector;
