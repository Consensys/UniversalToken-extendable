...
export interface ExtendableTokenProxyInterface extends utils.Interface {
  functions: {
...
export interface ExtendableTokenProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExtendableTokenProxyInterface;
