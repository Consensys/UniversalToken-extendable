...
export interface ERC721TokenInterfaceInterface extends utils.Interface {
  functions: {
...
export interface ERC721TokenInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721TokenInterfaceInterface;
