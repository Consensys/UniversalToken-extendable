...
export interface TokenERC1820ProviderInterface extends utils.Interface {
  functions: {
...
export interface TokenERC1820Provider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenERC1820ProviderInterface;
